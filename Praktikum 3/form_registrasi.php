...
<body>
    ...
    <div class="row justify-content-center">
        ...
        <div class="form-group row">
            ...
            <div class="col-8">
            <input id="text1" name="nama" placeholder="Masukan Nama Lengkap" type="text" class="form-control">
            </div>
        </div>
        <div class="form-group row">
            ...
            <div class="custom-control custom-radio custom-control-inline">
                <input name="jenis_kelamin" id="radio_0" type="radio" class="custom-control-input" value="L"> 
            ...
            <div class="col-8">
                ...
                ?>
                    <div class="custom-control custom-checkbox custom-control-inline">
                        ...
                        <label for="skill_[<?= $i ?>]" class="custom-control-label">
                            <?= $k ?>
                        </label>
                    </div>
                <?php } ?>
